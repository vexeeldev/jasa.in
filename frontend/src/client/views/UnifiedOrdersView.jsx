      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="flex gap-3 mb-8">
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className="w-24 h-10 rounded-2xl bg-gray-100 animate-[pulse_1.8s_ease-in-out_infinite]"
            />
          ))}
        </div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Pantau progress pesanan dan projectmu
          </p>
        </div>
      ...
      {orders.length === 0 ? (
        <Card className="rounded-3xl border border-dashed border-gray-200 py-20 text-center">
          ...
          <p className="text-gray-500 mb-6">
            Yuk mulai cari jasa dan buat project pertamamu
          </p>
          ...
          {orders.map((order) => {
            ...
            return (
              <Card
                ...
                onClick={() =>
                  navigate(
                    `/client/order-track/${order.ORDER_ID}`
                  )
                }
                className="group rounded-3xl border border-gray-100 bg-white p-5 hover:shadow-md transition-all duration-300 cursor-pointer"
              >
                ...
                <div className="mt-5 pt-4 border-t border-gray-100 flex items-center justify-between">
                  ...
                  <button className="flex items-center gap-1.5 text-sm font-medium text-emerald-600 hover:text-emerald-700 transition-all">
